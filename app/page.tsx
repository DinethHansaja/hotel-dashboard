          ...
          <div className="grid items-stretch gap-5 lg:grid-cols-[minmax(0,1.8fr)_minmax(320px,0.8fr)]">
            ...
            <div className="flex min-w-0 flex-col gap-5">
              ...
              <section className="rounded-[24px] border border-slate-200 bg-white px-6 py-7 shadow-sm md:px-8 md:py-8">
                ...
                <h2 className="mt-2 max-w-4xl text-2xl font-bold tracking-tight text-[#111827] md:text-3xl">
                ...
                <p className="mt-3 max-w-4xl text-sm leading-7 text-slate-500 md:text-base">
                  Discover hotels, restaurants, buffet experiences,
                  events and dining options across Colombo. Compare
